...
class CustomAdvisorDropdownButton extends StatelessWidget {
  TextStyle textStyle;
  List<SystemUser> data;
  String? iconPath;
  ...
  Function(SystemUser)? onChange;
  CustomAdvisorDropdownButton(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButtonFormField<SystemUser>(
          hint: hint != null
              ? Text(
            hint!,
          ...
          validator: (value) {
            if(value==null){
              ...
              return validateDropDown(value.name);
            }
          ...
          items: data.map((SystemUser value) {
            return DropdownMenuItem<SystemUser>(
              value: value,
              child: Center(
                child: FittedBox(
                  child: Row(
